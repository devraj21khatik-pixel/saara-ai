...
CORS(app)  # Mobile/WebView se cross-origin requests allow karne ke liye
application = app  # Vercel entrypoint alias
...
def home():
    ...
    return jsonify({"status": "Saara Backend is Active!"})
